// Ported verbatim from the authority doc (motion-primitives / text-effect),
// TypeScript stripped to JS. Logic and variants are unchanged; styling is left
// entirely to the className the caller passes, so it inherits JOBZE tokens.
